    ...
    <div class="col-lg-8 mx-auto p-3 py-md-5">
        <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
            <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
                ...
                <span class="fs-4">Городской портал</span>
            </a>
        </header>
        <main>
            {{ $content }}
        ...
        <footer class="pt-5 my-5 text-muted border-top">
            Created by Noob &middot; &copy; 2023
        </footer>
    </div>

    <script src="/script/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous">
    </script>
</body>
